...
> Design notes for **phone-otp-appointment-reminder** — a runnable typescript example that Typed Node service for phone OTP login and patient-safe appointment reminder previews.
...
- **Feature code** — the actual task: healthtech OTP login.
